...
const FlightCard = ({ flightData }) => {
  ...
  const { setSingleTripBookResult } = UseStateContext();
  ...
  const handleBookFlight = () => {
    ...
    const selectedPlane = [flightData];
    ...
    axiosPrivateUrl
      ...
      .then((response) => {
        ...
        setSingleTripBookResult(response?.data);
  ...
  return (
    <div className="FlightCardContainer bg-gray-50 py-5 px-8 border border-gray-300 shadow-lg rounded-md my-6   ">
